...
description: Submission guidelines for SciForDL 2026
edition: 2026
nav: true
nav_order: 2
---
...
**Detailed submission guidelines will be announced soon.**
...
- **Paper length**: TBD (likely 4-8 pages excluding references)
- **Template**: Standard ICLR format
- **Review process**: Double-blind peer review
- **Acceptance types**: Oral presentations and poster sessions
